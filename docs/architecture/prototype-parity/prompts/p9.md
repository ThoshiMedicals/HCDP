# Cursor Prompt — Programme P9: Whole-platform production verification
...
Modules/surfaces: Platform-wide

Repos/migrations, isolation, security, connectors, backup, performance, monitoring, release controls.
