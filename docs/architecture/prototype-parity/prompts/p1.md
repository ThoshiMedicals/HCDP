# Cursor Prompt — Programme P1: Shared final-design foundation
...
Modules/surfaces: Shared shell + workbench primitives

No module business-logic redesign. Add design-reference screenshot harness.
