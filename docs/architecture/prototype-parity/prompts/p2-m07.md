# Cursor Prompt — Programme P2-M07: Final-design conversion — M07 ordinary prep
...
Modules/surfaces: M07 Staff Pay preparation only

No PPA. No payment execution. Shared workbench only.
