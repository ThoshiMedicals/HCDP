...
- **Scope:** M21
- **Module:** M21
- **Primary route:** `/vendor-console`
- **Design reference:** `derived-from-design-contract`
- **Screen IDs (sample/full list in registers):** `screen_ccc228ef4693`
- **Requirement IDs (non-exhaustive; full SoT in master register):** `prod-route-vendor-console`, `prod-section-vendor-console-tenants`, `prod-section-vendor-console-provisioning`, `prod-section-vendor-console-platform-health`, `bp_6e5189a4a0cc`, `bpmetric_bf7e4bc7efb8`, `bpmetric_77e3cf142467`, `bpmetric_9fdf315051bd`, `bpmetric_e88b02a630be`, `bppattern_f4ac92cc8187`, `bppattern_961505f4a5ec`, `bppattern_046f1be9dff6`, `bppattern_2a5b608f85d2`
...
- Action/workflow IDs in scope: `bpflow_fd87ebac39c8`, `bpflow_4dd5968965bd`, `bpflow_2b899d5d0b3a`
...
- Owner note: Vendor-level provisioning and portfolio operations
...
- Visual QA against Decision A PNG / design-contract pattern for M21  
