...
Classification **Moderate**. Priority P1-rec. Batch P1-B2. Status `P1 — PLANNED, NOT AUTHORISED`. Owner clarification **Yes** on seed copy cleanup vs retain for QA.
...
Classification **Minor**. Priority P1-rec honesty. Batch P1-B2. Status `P1 — PLANNED, NOT AUTHORISED`.
