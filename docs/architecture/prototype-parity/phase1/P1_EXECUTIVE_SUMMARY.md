...
As of **2026-08-13**, **P1-B1**, **P1-B2** and **P1-B3** are **owner accepted with qualifications** and **closed** at tips `fdb2beb5b0e786e42d358efa9875b6bba52666cd`, `66f3f8d27803f5b8d24043639d21b9069f58e77a` and `2515a4ffac0fb94cbd37092e26bf372cb43898f8` respectively (local validation basis; no GitHub CI). **P1-B4** is expressly authorised and **implemented for owner review** (acceptance **pending**) on `cursor/p1-b4-responsive-a11y-appearance` (source tip `c5d919cc2921ab43949b37cad499e29a79cfa6b0`). This does **not** authorise P1-B5–P1-B8, PR/merge/deploy, production, or automatic progression; gaps 008/009/031/052/074 remain **not closed**. `OWN-P1-011` and `OWN-P1-016` remain **open**. Aurora remained isolated.
...
| **Programme P1 (SHARED-first)** | SHARED shell / Decision A foundation first; B5–B8 need separate explicit auth (OWN-P1-002) | Planning closed; B1/B2/B3 closed with qualifications; B4 implemented for owner review (acceptance pending); B5–B8 still **not** authorised |
...
4. **P1-B4** — Shared responsive / a11y / appearance evidence hardening — **expressly authorised; implemented for owner review (acceptance pending)** (evidence: [`../../audits/p1/P1_B4_IMPLEMENTATION_EVIDENCE.md`](../../audits/p1/P1_B4_IMPLEMENTATION_EVIDENCE.md); briefing: [`P1_B4_OWNER_AUTHORISATION_BRIEFING.md`](./P1_B4_OWNER_AUTHORISATION_BRIEFING.md))
...
**Still open / unauthorised:** OWN-P1-009…015 (deferred; includes **OWN-P1-011** PPA product); **OWN-P1-016** before production data path; P1-B5–P1-B8 implementation. P1-B4 owner acceptance remains **pending**.
...
**Current programme claim:** `P1-B4 responsive, accessibility, reduced-motion and System-appearance hardening expressly authorised, implemented and published for owner review — owner acceptance remains pending; P1-B5–P1-B8 remain unauthorised; Aurora remained isolated.`
