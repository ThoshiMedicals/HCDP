...
|---|---|---|---|---|---|
| R-5.1-01 | 5.1 | Eligible population resolver | `eligible-population-service.ts` | CP5.1 | proven |
...
| R-5.3-03 | 5.3 | SoD vs submitter/preparers | `sod-policy.ts` | CP5.2–5.3 | proven |
| R-5.4-01 | 5.4 | Source manifest + checksum | `source-manifest-service.ts` | CP5.2–5.4 | proven |
| R-5.4-02 | 5.4 | Invalidation on source change | `approval-invalidation.ts` | CP5.4 | proven |
| R-5.5-01 | 5.5 | M02 bridge lifecycle | `m02-inbox-publish.ts` | CP5.5 | proven |
