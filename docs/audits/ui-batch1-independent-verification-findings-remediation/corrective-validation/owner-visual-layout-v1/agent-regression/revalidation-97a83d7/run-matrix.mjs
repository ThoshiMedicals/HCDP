#!/usr/bin/env node
/**
 * Wrapper: IV matrix → revalidation-97a83d7/prod-matrix.
 * Repo validate.mjs unmodified; uses cwd-relative HCDP_OUT_DIR.
 */
...
const APP_SHA =
  process.env.HCDP_APP_SHA || "97a83d7beb219ce01a7b12c6f70a975a44614d59";
  ...
  JSON.stringify(
    {
      ...
      script,
      cwd: WT,
      note: "Wrapper only; repo validate.mjs unmodified. Historical prod-matrix-v3 not touched.",
    },
    null,
    2
  )
