/**
 * Visual QA Agent — complete capture at frozen SHA 05f0711 against :3501
 * Evidence-only; does not modify src/ or scripts/.
 * Writes under agent-visual-qa/final-05f0711/
...
const APP_SHA = "05f07119ec2883b7ec7a2da6bbe3b5162257c2ec";
...
async function probeTopbarRibbon(page) {
  return page.evaluate(() => {
    ...
    // Owner criteria at 05f0711: Export / New Entry / Enterprise all deferred until 2xl.
