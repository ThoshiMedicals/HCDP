...
| Started | 2026-08-04T06:23:53.642Z |
| Finished | 2026-08-04T06:27:43.300Z |
...
- Steps: PASS 189 / FAIL 0 / OUT_OF_SCOPE 1
- Open WQA findings: **0**
...
| --- | --- | --- | --- | --- |
| 1 | Empty git diff 05f0711 -- src scripts | 0 lines | 0 | PASS |
| 2 | GET /dashboard on :3501 | HTTP 2xx | status=200 url=http://127.0.0.1:3501/dashboard | PASS |
| 3 | GET app CSS on :3501 | HTTP 200 | href=/_next/static/css/fc4fccb65dcb8256.css status=200 | PASS |
...
| 9 | Search → Staff Pay | /staffpay | http://127.0.0.1:3501/staffpay | PASS |
| 10 | Mobile Open menu | visible | visible=true | PASS |
| 11 | Mobile search → Action Inbox | /action-inbox | http://127.0.0.1:3501/action-inbox | PASS |
