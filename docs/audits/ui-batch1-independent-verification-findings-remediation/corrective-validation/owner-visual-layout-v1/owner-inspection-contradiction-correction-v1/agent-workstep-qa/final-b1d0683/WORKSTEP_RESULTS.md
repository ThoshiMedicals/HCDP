...
| Started | 2026-08-04T06:08:31.004Z |
| Finished | 2026-08-04T06:12:18.257Z |
...
- Steps: PASS 187 / FAIL 0 / OUT_OF_SCOPE 1
- Open WQA findings: **0**
...
| --- | --- | --- | --- | --- |
| 1 | Empty git diff b1d0683 -- src scripts | 0 lines | 0 | PASS |
| 2 | GET /dashboard on :3501 | HTTP 2xx | status=200 url=http://127.0.0.1:3501/dashboard | PASS |
| 3 | GET app CSS on :3501 | HTTP 200 | href=/_next/static/css/aef84fda6bfb6c30.css status=200 | PASS |
...
- Route: `/dashboard`
- Starting state: desktop+xl+mobile
- Outcome: **PASS**
- Screenshots: screenshots/WF-TOPBAR-390.png, screenshots/WF-TOPBAR-1440.png
...
| 5 | Export visible at xl+ (1440) | Topbar Export visible + operable (display≠none) | {"exportVis":true,"exportDisplay":"flex","exportProbe":{"present":true,"text":"Export","rect":{"top":13.5,"left":1285.34375,"right":1353.53125,"bottom":50,"width":68.1875,"height":36.5},"visible":true,"fullyInViewport":true,"pageHorizontalScroll":false,"covered":false,"disabled":false,"pointerEvents":"auto","operable":true}} | PASS |
| 6 | Topbar Export hidden below xl (1024) | display=none (topbar only) | visible=false display=none | PASS |
| 7 | Search → Staff Pay | /staffpay | http://127.0.0.1:3501/staffpay | PASS |
| 8 | Mobile Open menu | visible | visible=true | PASS |
| 9 | Mobile search → Action Inbox | /action-inbox | http://127.0.0.1:3501/action-inbox | PASS |
