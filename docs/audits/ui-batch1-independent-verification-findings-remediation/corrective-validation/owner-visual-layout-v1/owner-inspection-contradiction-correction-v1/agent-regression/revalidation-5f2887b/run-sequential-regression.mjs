...
const EV =
  process.env.HCDP_EV ||
  "/tmp/hcdp-fix/ui-batch1-contradiction-v1/docs/audits/ui-batch1-independent-verification-findings-remediation/corrective-validation/owner-visual-layout-v1/owner-inspection-contradiction-correction-v1/agent-regression/revalidation-5f2887b";
const LOGS = join(EV, "logs");
mkdirSync(LOGS, { recursive: true });

const FROZEN = "5f2887b7faf5ffd276a03735835b7b61ec873508";
const EXPECTED_HASH =
