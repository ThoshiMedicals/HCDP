...
const EV =
  process.env.HCDP_EV ||
  "/tmp/hcdp-fix/ui-batch1-contradiction-v1/docs/audits/ui-batch1-independent-verification-findings-remediation/corrective-validation/owner-visual-layout-v1/owner-inspection-contradiction-correction-v1/agent-regression/revalidation-f397c5a";
const LOGS = join(EV, "logs");
mkdirSync(LOGS, { recursive: true });

const FROZEN = "f397c5a81dff3b58242ff484ad0fc18aa840ec19";
const EXPECTED_HASH =
