...
const EV =
  process.env.HCDP_EV ||
  "/tmp/hcdp-fix/ui-batch1-contradiction-v1/docs/audits/ui-batch1-independent-verification-findings-remediation/corrective-validation/owner-visual-layout-v1/owner-inspection-contradiction-correction-v1/agent-regression/revalidation-b1d0683";
const LOGS = join(EV, "logs");
mkdirSync(LOGS, { recursive: true });

const FROZEN = "b1d0683057882546b68c73b1ae679630d8dbbcb8";
const EXPECTED_HASH =
