...
const WT = process.env.HCDP_WT || "/tmp/hcdp-fix/ui-batch1-contradiction-v1";
const EV =
  process.env.HCDP_EV ||
  "/tmp/hcdp-fix/ui-batch1-vf-fixes/docs/audits/ui-batch1-independent-verification-findings-remediation/corrective-validation/owner-visual-layout-v1/owner-inspection-contradiction-correction-v1/agent-regression/revalidation-05f0711";
const LOGS = join(EV, "logs");
mkdirSync(LOGS, { recursive: true });

const FROZEN = "05f07119ec2883b7ec7a2da6bbe3b5162257c2ec";
const EXPECTED_HASH =
...
const suites = [
  ...
  { id: "27", name: "npm-build", cmd: ["npm", "run", "build", "--", "--webpack"], kind: "build" },
  {
    id: "28",
    name: "hash-gate",
