/**
 * Visual QA Agent — complete capture at frozen SHA 31b3111 against :3502
 * Evidence-only; does not modify src/ or scripts/.
 * Writes under agent-visual-qa/final-31b3111/
...
const { chromium } = require("/tmp/hcdp-fix/ui-batch1-vf-fixes/node_modules/playwright");
...
async function probeTopbarRibbon(page) {
  return page.evaluate(() => {
    ...
    // Owner criteria at 31b3111: Export / New Entry / Enterprise all deferred until 2xl.
