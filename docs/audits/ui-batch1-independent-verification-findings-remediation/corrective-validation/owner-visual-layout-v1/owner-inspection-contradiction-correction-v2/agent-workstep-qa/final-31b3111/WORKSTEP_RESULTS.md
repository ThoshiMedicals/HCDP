...
| Frozen app SHA | `31b31115fa1bab99e2cea47c8526a4c8011e2fe2` |
| Worktree | `/tmp/hcdp-fix/ui-batch1-vf-fixes` |
| Server | `http://127.0.0.1:3502` |
| Started | 2026-08-06T01:56:52.550Z |
| Finished | 2026-08-06T02:00:37.488Z |
...
| --- | --- | --- | --- | --- |
| 1 | Empty git diff 31b3111 -- src scripts | 0 lines | 0 | PASS |
| 2 | GET /dashboard on :3502 | HTTP 2xx | status=200 url=http://127.0.0.1:3502/dashboard | PASS |
| 3 | GET app CSS on :3502 | HTTP 200 | href=/_next/static/chunks/2vnwyr9hm6wom.css status=200 | PASS |
...
| 3 | Refresh live board (demo) | Click completes; no crash | toast=Acting as Sarah Mitchell url=http://127.0.0.1:3502/time-attendance?section=live | PASS |
...
| 3 | Bulk approve pending (demo) | Click completes; no crash | toast=Acting as Sarah Mitchell url=http://127.0.0.1:3502/time-attendance?section=approvals | PASS |
...
| 3 | Request correction (demo) | Click completes; no crash | toast=Acting as Sarah Mitchell url=http://127.0.0.1:3502/time-attendance?section=corrections | PASS |
...
| 3 | Publish policy (demo) | Click completes; no crash | toast=Acting as Sarah Mitchell url=http://127.0.0.1:3502/time-attendance?section=settings | PASS |
...
| # | Action | Expected | Observed | Result |
| --- | --- | --- | --- | --- |
| 1 | Topbar Dashboard | /dashboard | http://127.0.0.1:3502/dashboard | PASS |
| 2 | Topbar Action Inbox | /action-inbox | http://127.0.0.1:3502/action-inbox | PASS |
...
| 9 | Search → Staff Pay | /staffpay | http://127.0.0.1:3502/staffpay | PASS |
| 10 | Mobile Open menu | visible | visible=true | PASS |
| 11 | Mobile search → Action Inbox | /action-inbox | http://127.0.0.1:3502/action-inbox | PASS |
...
| # | Action | Expected | Observed | Result |
| --- | --- | --- | --- | --- |
| 1 | Deep link overview | /Workforce overview/i | heading="Workforce overview" url=http://127.0.0.1:3502/staff-doctors?section=overview | PASS |
| 2 | Deep link people | /People directory/i | heading="People directory" url=http://127.0.0.1:3502/staff-doctors?section=people | PASS |
| 3 | Deep link staff-profiles | /Staff profiles/i | heading="Staff profiles" url=http://127.0.0.1:3502/staff-doctors?section=staff-profiles | PASS |
| 4 | Deep link doctor-profiles | /Doctor profiles/i | heading="Doctor profiles" url=http://127.0.0.1:3502/staff-doctors?section=doctor-profiles | PASS |
| 5 | Deep link engagements | /Engagements/i | heading="Engagements" url=http://127.0.0.1:3502/staff-doctors?section=engagements | PASS |
| 6 | Deep link credentials | /Credentials/i | heading="Credentials" url=http://127.0.0.1:3502/staff-doctors?section=credentials | PASS |
| 7 | Deep link leave-availability | /Leave & availability/i | heading="Leave & availability" url=http://127.0.0.1:3502/staff-doctors?section=leave-availability | PASS |
| 8 | Deep link restrictions | /Restrictions/i | heading="Restrictions & adjustments" url=http://127.0.0.1:3502/staff-doctors?section=restrictions | PASS |
| 9 | Deep link onboarding | /Onboarding/i | heading="Onboarding" url=http://127.0.0.1:3502/staff-doctors?section=onboarding | PASS |
| 10 | Deep link offboarding | /Offboarding/i | heading="Offboarding" url=http://127.0.0.1:3502/staff-doctors?section=offboarding | PASS |
| 11 | Deep link reports | /Reports/i | heading="Reports" url=http://127.0.0.1:3502/staff-doctors?section=reports | PASS |
| 12 | Deep link settings | /Settings/i | heading="Settings" url=http://127.0.0.1:3502/staff-doctors?section=settings | PASS |
...
| # | Action | Expected | Observed | Result |
| --- | --- | --- | --- | --- |
| 1 | Deep link roster-board | /Roster Board/i | heading="Roster Board" url=http://127.0.0.1:3502/roster?section=roster-board | PASS |
| 2 | Deep link coverage | /Coverage/i | heading="Coverage" url=http://127.0.0.1:3502/roster?section=coverage | PASS |
| 3 | Deep link open-shifts | /Open Shifts/i | heading="Open Shifts" url=http://127.0.0.1:3502/roster?section=open-shifts | PASS |
| 4 | Deep link availability-leave | /Availability & Leave/i | heading="Availability & Leave" url=http://127.0.0.1:3502/roster?section=availability-leave | PASS |
| 5 | Deep link requests | /Requests/i | heading="Requests" url=http://127.0.0.1:3502/roster?section=requests | PASS |
| 6 | Deep link conflicts-warnings | /Conflicts & Warnings/i | heading="Conflicts & Warnings" url=http://127.0.0.1:3502/roster?section=conflicts-warnings | PASS |
| 7 | Deep link published-history | /Published History/i | heading="Published History" url=http://127.0.0.1:3502/roster?section=published-history | PASS |
| 8 | Deep link cost-forecast | /Cost Forecast/i | heading="Cost Forecast" url=http://127.0.0.1:3502/roster?section=cost-forecast | PASS |
| 9 | Deep link reports | /Reports/i | heading="Reports" url=http://127.0.0.1:3502/roster?section=reports | PASS |
| 10 | Deep link settings | /Settings/i | heading="Settings" url=http://127.0.0.1:3502/roster?section=settings | PASS |
...
| # | Action | Expected | Observed | Result |
| --- | --- | --- | --- | --- |
| 1 | Deep link live | /Live Attendance/i | heading="Live Attendance" url=http://127.0.0.1:3502/time-attendance?section=live | PASS |
| 2 | Deep link clock | /Clock In\/Out/i | heading="Clock In/Out" url=http://127.0.0.1:3502/time-attendance?section=clock | PASS |
| 3 | Deep link timesheets | /Timesheets/i | heading="Timesheets" url=http://127.0.0.1:3502/time-attendance?section=timesheets | PASS |
| 4 | Deep link exceptions | /Exceptions/i | heading="Exceptions" url=http://127.0.0.1:3502/time-attendance?section=exceptions | PASS |
| 5 | Deep link corrections | /Corrections/i | heading="Corrections" url=http://127.0.0.1:3502/time-attendance?section=corrections | PASS |
| 6 | Deep link approvals | /Approvals/i | heading="Approvals" url=http://127.0.0.1:3502/time-attendance?section=approvals | PASS |
| 7 | Deep link breaks | /Breaks/i | heading="Breaks" url=http://127.0.0.1:3502/time-attendance?section=breaks | PASS |
| 8 | Deep link history | /Attendance History/i | heading="Attendance History" url=http://127.0.0.1:3502/time-attendance?section=history | PASS |
| 9 | Deep link reports | /Reports/i | heading="Reports" url=http://127.0.0.1:3502/time-attendance?section=reports | PASS |
| 10 | Deep link settings | /Settings & Policies/i | heading="Settings & Policies" url=http://127.0.0.1:3502/time-attendance?section=settings | PASS |
...
| # | Action | Expected | Observed | Result |
| --- | --- | --- | --- | --- |
| 1 | Deep link overview | /Pay Run Overview/i | heading="Pay Run Overview" url=http://127.0.0.1:3502/staffpay?section=overview | PASS |
| 2 | Deep link people | /People Review/i | heading="People Review" url=http://127.0.0.1:3502/staffpay?section=people | PASS |
| 3 | Deep link leave | /Leave/i | heading="Leave & Allowances" url=http://127.0.0.1:3502/staffpay?section=leave | PASS |
| 4 | Deep link adjustments | /Adjustments/i | heading="Prior-period adjustments" url=http://127.0.0.1:3502/staffpay?section=adjustments | PASS |
| 5 | Deep link exceptions | /Exceptions/i | heading="Exceptions" url=http://127.0.0.1:3502/staffpay?section=exceptions | PASS |
| 6 | Deep link variances | /Variances/i | heading="Variances" url=http://127.0.0.1:3502/staffpay?section=variances | PASS |
| 7 | Deep link approval | /Approval/i | heading="Approval" url=http://127.0.0.1:3502/staffpay?section=approval | PASS |
| 8 | Deep link export | /Export/i | heading="Payroll export preparation" url=http://127.0.0.1:3502/staffpay?section=export | PASS |
| 9 | Deep link reconciliation | /Reconciliation/i | heading="Package reconciliation" url=http://127.0.0.1:3502/staffpay?section=reconciliation | PASS |
| 10 | Deep link history | /History/i | heading="History / Reports" url=http://127.0.0.1:3502/staffpay?section=history | PASS |
| 11 | Deep link settings | /Settings/i | heading="Settings" url=http://127.0.0.1:3502/staffpay?section=settings | PASS |
...
| # | Action | Expected | Observed | Result |
| --- | --- | --- | --- | --- |
| 1 | Reload retains M04 credentials | section=credentials | http://127.0.0.1:3502/staff-doctors?section=credentials | PASS |
| 2 | Back approvals → open-shifts | roster open-shifts | http://127.0.0.1:3502/roster?section=open-shifts | PASS |
| 3 | Forward → approvals | time-attendance approvals | http://127.0.0.1:3502/time-attendance?section=approvals | PASS |
| 4 | Reload M07 overview | section retained | http://127.0.0.1:3502/staffpay?section=overview | PASS |
