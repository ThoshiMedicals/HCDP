...
const WT = process.env.HCDP_WT || "/tmp/hcdp-fix/c2a-reg-3513";
const EV = process.env.HCDP_EV || "/tmp/hcdp-fix/ui-batch1-vf-fixes/docs/audits/ui-batch1-independent-verification-findings-remediation/corrective-validation/owner-visual-layout-v1/owner-inspection-contradiction-correction-v2/agent-regression/revalidation-b1152d3";
const LOGS = join(EV, "logs");
mkdirSync(LOGS, { recursive: true });

const FROZEN = "b1152d36d3f47c15277f85b3e990f5e1c94bddcb";
const EXPECTED_HASH =
