      ...
      <div className="mx-auto w-full max-w-[1480px] px-4 py-2.5 lg:px-7">
        <div className="flex flex-wrap items-center gap-2">
          <div className="relative" ref={clinicsRef}>
            ...
            {clinicsOpen ? (
              ...
              >
                ...
                <div className="mb-1 text-[length:var(--type-control)] font-extrabold uppercase tracking-wide text-[var(--cc-muted)]">
                  Saved groups
                </div>
                {otherClinicGroups.map((g) => (
                  ...
                  >
                    {g.name}
                    <span className="text-[length:var(--type-control)] text-[var(--cc-muted)]">{g.locationIds.length}</span>
                  </button>
                ))}
                {canSaveGroup ? (
                  <Button
                    ...
                    >
                      ...
                      {h ? (
                        <span className="flex shrink-0 items-center gap-1.5">
                          ...
                          <span className="whitespace-nowrap text-[length:var(--type-control)] font-bold text-[var(--cc-muted)]">
              ...
              <div className="absolute left-0 top-[110%] z-40 max-h-[280px] w-[260px] overflow-auto rounded-xl border border-[var(--cc-card-line)] bg-[var(--cc-card)] p-1 shadow-xl">
                {layouts.map((l) => (
                  ...
                  >
                    {l.name}
                    {l.isDefault ? (
                      <span className="ml-auto text-[length:var(--type-control)] text-[var(--cc-muted)]">Default</span>
                    ) : null}
                  </button>
                ))}
          ...
          >
            Notifications
            {totalNotes > 0 ? (
              <span className="ml-1 inline-flex min-w-[18px] items-center justify-center rounded-full bg-[var(--cc-exec,#1e40af)] px-1 text-[length:var(--type-control)] font-black text-white">
                {totalNotes}
              </span>
            ) : null}
          </button>
