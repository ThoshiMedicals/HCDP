  ...
  return (
    <CcCard accent="#1e40af">
      ...
      <div className="cc-surface-info mx-4 mb-3 flex flex-wrap items-center gap-1.5 rounded-xl border p-2">
        ...
        <span className="text-[length:var(--type-control)] font-semibold text-[var(--cc-muted)]">
              ...
              <div className="flex flex-wrap items-start gap-2">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-2 grid gap-2">
                    ...
                    <div className="flex flex-wrap gap-1.5 text-[length:var(--type-control)] font-semibold text-[var(--cc-muted)]">
                      <button
                        type="button"
