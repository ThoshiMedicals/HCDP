/**
 * M06 attendance event publisher.
 */
...
const SOURCE_MODULE = "time-attendance" as const;
const ROUTE = "/time-attendance";

export type PublishM06EventInput = {
...
export function publishM06AttendanceEvent(input: PublishM06EventInput): PublishWorkforceEventResult {
