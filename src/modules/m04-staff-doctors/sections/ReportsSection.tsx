...
export function ReportsSection() {
  ...
  return (
    <div className="grid gap-4">
      <div>
        <h2 className="m-0 text-[length:var(--type-heading)] font-extrabold">Reports</h2>
        <p className="m-0 mt-1 text-[length:var(--type-body)] text-[var(--muted)]">Workforce counts and export (permission-gated).</p>
      </div>
