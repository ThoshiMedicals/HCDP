/**
 * M04 workforce event publisher.
 * Envelope: eventId, eventType, sourceModule staff-doctors, sourceRecordId,
 * sourceRecordVersion, organisationId, clinicId, occurredAt, actor, idempotencyKey.
 */
...
const SOURCE_MODULE = "staff-doctors" as const;
const ROUTE = "/staff-doctors";

export type PublishM04EventInput = {
...
export function publishM04WorkforceEvent(input: PublishM04EventInput): PublishWorkforceEventResult {
