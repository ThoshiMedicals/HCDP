...
export const PLATFORM_MODULES: PlatformModule[] = [
  ...
  },
  {
    ...
    shortName: "Training",
    purpose:
      "Wave 3 Training workspace (owner-accepted and frozen; not production-approved). Register metadata synchronised to verified TrainingWorkspace sections — metadata/register correction only; not a new domain implementation.",
    mainRoute: "/training",
    legacyRoutes: ["/training"],
    // Section IDs/labels derived from TrainingWorkspace NAV (verified runtime).
    sections: [
      { id: "overview", label: "Overview" },
      { id: "catalogue", label: "Course Catalogue", legacyTerms: ["Learning Catalogue", "courses"] },
      { id: "assignments", label: "Assignments", legacyTerms: ["records", "Training Records"] },
      { id: "sessions", label: "Sessions" },
      { id: "assessments", label: "Assessments" },
      { id: "competencies", label: "Competencies" },
      { id: "certificates", label: "Certificates", legacyTerms: ["expiry", "Expiry & Gates"] },
