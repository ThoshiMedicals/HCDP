...
export const PLATFORM_MODULES: PlatformModule[] = [
  ...
  },
  {
    ...
    purpose: "Staff and doctor registers, profiles, employment, credentials and HR documents.",
    mainRoute: "/staff-doctors",
    legacyRoutes: ["/staff", "/doctors", "/hr-docs"],
    sections: [
      { id: "staff", label: "Staff", legacyTerms: ["Staff"] },
      { id: "doctors", label: "Doctors", legacyTerms: ["Doctors"] },
      { id: "staff-profiles", label: "Staff Profiles" },
      { id: "doctor-profiles", label: "Doctor Profiles" },
      { id: "employment", label: "Employment" },
      { id: "credentials", label: "Credentials" },
      { id: "hr-documents", label: "HR Documents", legacyTerms: ["HR Documents", "HR Docs"] },
    ...
    relatedModuleIds: ["roster", "training", "recruitment"],
  ...
  },
  {
    ...
    legacyRoutes: ["/roster"],
    sections: [
      { id: "roster-grid", label: "Roster Grid" },
      { id: "shift-swaps", label: "Shift Swaps" },
      { id: "publish", label: "Publish & Notify" },
    ],
    icon: "calendar",
  ...
  },
  {
    ...
    sections: [
      { id: "attendance", label: "Attendance", legacyTerms: ["Time & Attendance", "Timeclock"] },
      { id: "clock-events", label: "Clock Events" },
      { id: "timesheets", label: "Timesheets" },
      { id: "exceptions", label: "Exceptions" },
      { id: "offline-reconciliation", label: "Offline Reconciliation", legacyTerms: ["Offline Reconciliation", "Sync Centre"] },
    ],
    icon: "calendar",
    navigationFamily: "Roster",
    accessClassification: "operational",
  ...
  },
  {
    ...
    sections: [
      { id: "pay-prep", label: "Pay Preparation" },
      { id: "exceptions", label: "Pay Exceptions" },
